<div>
    ...
    <div
        class="relative m-auto w-[60%] overflow-hidden overflow-x-auto rounded shadow-md sm:rounded-lg flex justify-center items-center">

        <!-- Create Modal toggle -->
        <button data-modal-target="create-modal" data-modal-toggle="create-modal"
            class="absolute block top-0 right-0 text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-3 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"
            type="button">
            Tambah Member
        </button>
        <!-- Create Modal toggle -->
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-4">
                            ...
                            <div class="col-span-2">
                                <label for="Hobi"
                                    ...
                                    Hobi</label>
                                <textarea id="Hobi" wire:model='hobi' rows="4"
                                    class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="Tambahkan hobi disini..."></textarea>
                            </div>
                        ...
                        <form class="p-4 md:p-5" novalidate>
                            <div class="grid grid-cols-2 gap-4 mb-4">
                                ...
                                <div class="col-span-2 ">
                                    <label for="kekayaan"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Kekayaan</label>
                                    <input type="number" wire:model='kekayaan' name="kekayaan" id="kekayaan"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                ...
                                <div class="col-span-2">
                                    <label for="Hobi"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                                        Hobi</label>
                                    <textarea id="Hobi" wire:model='hobi' name="hobi" rows="4"
                                        class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        placeholder="Tambahkan hobi disini..."></textarea>
                                </div>
                    ...
                    @foreach ($datas as $key => $value)
                        <tr wire:key="{{ $value->id }}"
                            ...
                            <td class="px-6 py-4 text-right">
                                <a href="#" wire:click='editDialog({{ $value->id }})'
